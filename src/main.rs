...
// Also another note, we do not use the original smoothstep function, i replaced it with a sigmoid tanh(x) as the big benefit of it is that it doesn't require clamping, as the domain of tanh() is (-1;1)
